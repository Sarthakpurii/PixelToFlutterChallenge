...
import 'package:pixeltoflutter/Ticket%20Booking%20App/screens/home-screen.dart';


final ThemeData ticketBookingTheme=ThemeData(
...
void main() {
  runApp(MaterialApp(
    theme: ticketBookingTheme,
    home: const TicHomeScreen(),
  ));
}